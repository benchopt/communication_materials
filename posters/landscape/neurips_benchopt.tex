...
\raisebox{-1em}{\includegraphics[height=2.6em]{qr-template}}
\\}
}
...
% Benchmark Lasso
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Lasso}{name=lasso,column=0,below=resnet,span=4,bottomaligned=benchmarks}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% \]
\centering
\includegraphics[width=0.7\textwidth,trim={0 48em 0 0},clip]{meg_rcv1_news20_MSD.pdf}
% \includegraphics[width=\textwidth,trim={0 0 0 62em},clip]{meg_rcv1_news20_MSD.pdf}\\[.5em]
\hspace{6mm}\raisebox{1em}{
\includegraphics[width=.2\textwidth]{meg_rcv1_news20_MSD_legend_vert}}\\
